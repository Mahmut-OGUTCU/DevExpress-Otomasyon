...
namespace CR_SFC.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class CR_SFCAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private CR_SFC.Module.CR_SFCModule module3;
        private CR_SFC.Module.Web.CR_SFCAspNetModule module4;
        ...
        public CR_SFCAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void CR_SFCAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new CR_SFC.Module.Web.CR_SFCAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.CR_SFCAspNetApplication_DatabaseVersionMismatch);
